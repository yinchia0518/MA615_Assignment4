...
The advantage is we can keep the original lists or data frames, but still create tibbles using them. So if I want to keep the backwards compatibility with data frames and list, but still need tibbles, I will use this enframe.
